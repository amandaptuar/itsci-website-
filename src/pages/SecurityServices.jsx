...
.hero__bg{
  ...
  background-image:url('/images/new-banner/Cyber-security-banner.jpg');
  ...
  .footer__grid{grid-template-columns:1fr;text-align:center;}
        ...
        <div className="container">
          ...
          <div className="hero__grid">
            <div className="hero__copy">
              <h1 className="hero__title">Security Services</h1>
              <p className="hero__text">Monitor premises and deter crime with successful CCTV surveillance and security operations.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="content-section">
        <div className="container content-grid">
          <div>
            <p className="eyebrow">MONITOR & DETER</p>
            <h2>CCTV Surveillance</h2>
            <p>Closed Circuit Television (CCTV) surveillance is an important tool to successfully monitor premises and deter crime. Large number of businesses and government agencies use CCTV to monitor and collect video/audio evidence.</p>
            <p>ITSCI deployed and engaged in maintaining medium to enterprise size CCTV surveillance systems consisting of hundreds cameras. We deployed surveillance system that allow our customers to monitor multiple locations from a single Security Operations Center (SOC).</p>
          </div>
          <div>
             <div style={{width:'100%', height:'350px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/cctv.jpg" alt="CCTV Surveillance" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="container content-grid">
          <div>
             <div style={{width:'100%', height:'450px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/cctv-camera-traffic-security-room.jpg" alt="Security Operations Center" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
          <div>
            <p className="eyebrow">EXPERTISE & VALUE</p>
            <h2>Designed to Meet Your Needs</h2>
            <p>Our engineers have knowledge and necessary field experience to design and implement the system that will meet your needs and budget, while giving you flexibility to expand as your business growth.</p>
            <ul className="content-list">
              <li>Quality video evidence helps solve crime and increases apprehensions by private security and police agencies.</li>
              <li>Saves money by identifying operational issues.</li>
              <li>Acts as a deterrent to those that would consider being dishonest.</li>
              <li>Video evidence often eliminates or significantly reduces exposure to litigation via fraudulent or frivolous claims.</li>
              <li>All too often businesses discover product or money missing weeks after the fact. Having video archives available to go back and review often solves these mysteries.</li>
              <li>Video analytics – let video help the operational side of your business by mapping customer patterns, counting people, capturing license plates and more.</li>
            </ul>
          </div>
        </div>
      </section>
