    ...
    <div className="offer__grid">
      <article className="offer__card">
        ...
        <div>
          ...
          <a href="/services/ai-development" className="link">Learn More <svg viewBox="0 0 24 24" className="arrow"><path d="M5 12h13m-5-6 6 6-6 6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a>
        </div>
      </article>
