...
.hero__bg{
  ...
  background-image:url('/images/new-banner/infra-1.jpg');
  ...
  .footer__grid{grid-template-columns:1fr;text-align:center;}
        ...
        <div className="container">
          ...
          <div className="hero__grid">
            <div className="hero__copy">
              <h1 className="hero__title">Infrastructure Services</h1>
              <p className="hero__text">Transforming your infra and ops to support an agile, nimble, and secure hybrid IT environment.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="content-section">
        <div className="container content-grid">
          <div>
            ...
            <h2>Always Ready in an Always On World</h2>
            <p>ITSCI Infrastructure services are designed to resolve and meet these requirements of global enterprises.</p>
            <p>Our solutions enable business-friendly infrastructure services to keep enterprises ‘always ready’ in an ‘always on’ world. We help transform your infra and ops to support the demands of an agile, nimble, and secure hybrid IT environment. Our next-gen infrastructure solutions and services find cost efficiencies in run and build operations to fund digital and other business transformations.</p>
          </div>
          <div>
             <div style={{width:'100%', height:'350px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/new-banner/infra2.jpg" alt="Infrastructure Performance" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="content-section" style={{background: 'var(--surface-2)'}}>
        <div className="container content-grid">
          <div>
             <div style={{width:'100%', height:'350px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/network-design/network-design.jpg" alt="Infrastructure Transformation" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
          <div>
            <p className="eyebrow">OPERATIONS</p>
            <h2>Comprehensive Infrastructure Management</h2>
            <p>With a comprehensive bouquet of infrastructure management services including Data-center services, End-user support, AI-led automation, Network and Communication, Cloud Services, Security and Digital Operations, we manage your infrastructure seamlessly and with unmatched efficiency</p>
            <p>Our Infrastructure Management and outsourcing services help customers reduce costs, accelerate time-to-market, enhance operational efficiencies and simplify IT management.</p>
          </div>
        </div>
      </section>
