...
.hero__bg{
  ...
  background-image:url('/images/telecom-page.jpg');
...
.nav__dropdown{
  ...
  box-shadow:0 12px 35px rgba(0,0,0,0.12);padding:10px 0;min-width:260px;
        ...
        <div className="container">
          ...
          <div className="hero__grid">
            <div className="hero__copy">
              <h1 className="hero__title">Telecom Management Services</h1>
              <p className="hero__text">Seamless, world-class managed services</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="content-section">
        <div className="container content-grid">
          <div>
            ...
            <h2>Seamless, world-class managed services</h2>
            <p>We run managed services for telecom mobility solutions providers. This helps them augment their productivity and ensures smooth flow of business processes.</p>
          ...
          <div>
             <div style={{width:'100%', height:'350px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/big-image-telcom.jpg" alt="Telecom Management" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="container content-grid">
          <div>
             <div style={{width:'100%', height:'450px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/telecom-industry.jpg" alt="Telecom Services" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
          <div>
            <p className="eyebrow">KEY TENETS</p>
            <h2>The key tenets of our managed services model are:</h2>
            <ul className="content-list">
              <li>Standardized process framework aligned to ITIL</li>
              <li>KPIs (Key Performance Indicators) and process controls</li>
            </ul>

            <h2 style={{marginTop: '40px'}}>Our current telecom offerings for managed services can be broken into the following main groups:</h2>
            <ul className="content-list">
              <li>Telecom software products</li>
              <li>Professional services for software deployment</li>
              <li>Risk management consulting services for solution and process design</li>
              <li>Security services to address the volatile nature of security threats</li>
              <li>Data Science services to bring the insights from data</li>
            </ul>
          </div>
        </div>
      </section>
