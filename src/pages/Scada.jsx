...
.hero__bg{
  ...
  background-image:url('/images/new-banner/web-security.jpg');
  ...
  .footer__grid{grid-template-columns:1fr;text-align:center;}
        ...
        <div className="container">
          ...
          <div className="hero__grid">
            <div className="hero__copy">
              <h1 className="hero__title">SCADA Systems</h1>
              <p className="hero__text">Supervisory Control and Data Acquisition solutions for modern infrastructure.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="content-section">
        <div className="container content-grid">
          <div>
            ...
            <h2>Reliable Monitoring and Control</h2>
            <p>Supervisory Control and Data Acquisition (SCADA) systems are the backbone of modern industrial automation. These systems are critical for controlling processes locally or at remote locations, interacting with devices such as sensors, valves, pumps, and motors.</p>
            <p>Our SCADA solutions are engineered to ensure high reliability, security, and real-time data visibility. Whether you're managing a power grid, water treatment facility, or manufacturing plant, our deployments give operators the control they need to optimize efficiency and respond immediately to potential issues.</p>
          </div>
          <div>
             <div style={{width:'100%', height:'450px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/portfolio/18.jpg" alt="SCADA Automation" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="content-section" style={{background: 'var(--surface-2)'}}>
        <div className="container content-grid">
          <div>
             <div style={{width:'100%', height:'450px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/portfolio/19.jpg" alt="SCADA Monitoring" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
          <div>
            <p className="eyebrow">OUR EXPERTISE</p>
            <h2>Comprehensive SCADA Services</h2>
            <p>From initial design and integration to legacy system upgrades and ongoing maintenance, our engineers possess the technical prowess to handle the most demanding SCADA projects. We prioritize secure communications and robust data logging.</p>
            <ul className="content-list">
              <li>Human-Machine Interface (HMI) Design</li>
              <li>Remote Telemetry Units (RTU) & PLC Programming</li>
              <li>Secure Industrial Communication Networks</li>
              <li>Real-time Data Acquisition and Logging</li>
              <li>Legacy SCADA System Upgrades</li>
            </ul>
          </div>
        </div>
      </section>
