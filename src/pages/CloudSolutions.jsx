...
.hero__bg{
  ...
  background-image:url('/images/cloud-computing/cloud-solution-banner.jpg');
...
.content-list strong { color: var(--ink-900); }
  ...
  .footer__grid{grid-template-columns:1fr;text-align:center;}
        ...
        <div className="container">
          ...
          <div className="hero__grid">
            <div className="hero__copy">
              <h1 className="hero__title">Cloud Solutions</h1>
              <p className="hero__text">Scale dynamically, optimize efficiencies, and elevate your business with next-level cloud computing.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="content-section">
        <div className="container content-grid">
          <div>
            <p className="eyebrow">GLOBAL TRANSFORMATION</p>
            <h2>Keep Pace with the Future</h2>
            <p>Cloud computing is driving a huge transformation globally among developers, users and enterprises in how they access information, design/develop/implement applications and manage cost and infrastructure. The merits of cloud computing are widely accepted and organizations are moving quickly to keep pace with the transformation.</p>
            <p>Flexibility and scalability are going to be key drivers across various points in the business spectrum. Optimizing cloud technologies can improve platform efficiencies, enhance operational flexibility and business scalability with the potential to elevate businesses to the next level. Cloud computing services at ITSCI allows businesses to meet their future needs and dynamically scale cloud solutions as per their requirements. We help enterprises build cloud solutions from scratch, as well as facilitate the migration and maintenance of existing applications to cloud platforms.</p>
          </div>
          <div>
             <div style={{width:'100%', height:'450px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/cloud-computing/cloud-computing-way-of-business.jpg" alt="Cloud Transformation" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="container content-grid">
          <div>
             <div style={{width:'100%', height:'500px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/cloud-computing/cloud-computing.png" alt="Cloud Computing Services" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
          <div>
            <p className="eyebrow">OUR EXPERTISE</p>
            <h2>Cloud Computing Services</h2>
            <p>ITSCI has enabled design, development, integration and launch of effective cloud-based applications for many organizations across the globe. We offer cloud solutions and services for cloud application development, cloud platform architecture design, cloud migration, SaaS services, DevOps, service orchestration and much more. Our in-depth knowledge of cloud technology combined with our consultative and people-first approach allows us to tailor solutions that help enterprises reach their goals.</p>
            <ul className="content-list">
              <li><strong>Cloud & SaaS Operations:</strong> Unified cloud operations management & monitoring, performance optimization, cloud security, governance & compliance, NoC services, SLA management</li>
              <li><strong>Cloud Consulting:</strong> Could assessment & advice, cloud application, platform architecture, cloud audit & review, cost analysis & optimization</li>
              <li><strong>Cloud Infrastructure:</strong> Cloud migration, strategy, infrastructure security management, backup & restore solution</li>
              <li><strong>Cloud Development:</strong> Solution design, application development, software product development, cloud integration, migration & implementation, C2C connector, data management & analytics</li>
            </ul>
          </div>
        </div>
      </section>
