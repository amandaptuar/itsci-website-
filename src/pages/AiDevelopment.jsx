...
.hero__bg{
  ...
  background-image:url('/images/new-banner/data-driven-banner.jpg');
  ...
  .footer__grid{grid-template-columns:1fr;text-align:center;}
        ...
        <div className="container">
          ...
          <div className="hero__grid">
            <div className="hero__copy">
              <h1 className="hero__title">AI Development</h1>
              <p className="hero__text">Harnessing the power of Artificial Intelligence to automate, predict, and optimize.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="content-section">
        <div className="container content-grid">
          <div>
            <p className="eyebrow">NEXT-GENERATION SOLUTIONS</p>
            <h2>Empowering Business with AI</h2>
            <p>Artificial Intelligence is no longer a futuristic concept—it is a critical driver for modern business success. From intelligent automation to complex data analysis, AI allows organizations to operate smarter, faster, and more competitively.</p>
            <p>At ITSCI, we integrate cutting-edge AI technologies into your existing workflows. Our custom machine learning models are designed to uncover hidden insights within your data, helping you make proactive decisions and optimize every aspect of your enterprise operations.</p>
          </div>
          <div>
             <div style={{width:'100%', height:'450px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/slides/slider-mainbg-001.jpg" alt="AI Development" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="content-section" style={{background: 'var(--surface-2)'}}>
        <div className="container content-grid">
          <div>
             <div style={{width:'100%', height:'450px', background:'#eee', borderRadius:'14px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
               <img src="/images/slides/slider-mainbg-002.jpg" alt="Machine Learning Services" style={{width:'100%', height:'100%', objectFit:'cover'}} />
             </div>
          </div>
          <div>
            <p className="eyebrow">OUR EXPERTISE</p>
            <h2>Machine Learning & Deep Learning</h2>
            <p>We provide full-lifecycle AI development services. Whether you need predictive analytics, natural language processing (NLP), or computer vision, our expert data scientists and AI engineers have the skills to build solutions that scale with your ambitions.</p>
